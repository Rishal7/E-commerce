...
<div class="max-w-2xl mx-auto">
	...
	<div class="bg-white shadow-md rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
		<a href="#">
			<img class="rounded-t-lg p-8" src="{{ asset('storage/' . $product->thumbnail) }}" alt="product image">
        </a>
			<div class="px-5 pb-5">
				<a href="#">
				...
				<div class="flex items-center justify-between mt-2">
					<span class="text-3xl font-semibold text-gray-900 dark:text-white">₹{{number_format($product->price)}}</span>
					<form action="/cart/add/{{$product->id}}" method="POST">
                        @csrf
                        <button type="submit"
                            class="transition-colors duration-300 text-xs font-semibold bg-blue-500 text-white hover:bg-blue-600 rounded-xl py-3 px-4">Add
                            to cart
                        </button>
                    </form>
				</div>
